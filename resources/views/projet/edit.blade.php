@extends('layouts.app')
@section('pageTitle', 'modifier Projet')
...
@section('content')
    ...
    <div class="container formulaire">
        <div class="row">
            ...
            <form action="{{url('projets/'.$projet->id)}}" class="form-horizontal" method="post">
            ...
            <!--Begin Title of Formation-->
                <div class="form-group form-group-lg @if($errors->get('Projet')) has-error @endif">
                    ...
                    <div class="col-sm-10 col-md-4">
                        <input type="text" name="Projet" class="form-control" value="{{$projet->titre}}"/>
