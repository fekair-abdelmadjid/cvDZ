@extends('layouts.app')
@section('pageTitle', 'Modifier expérience')
...
@section('content')
    ...
    <div class="container formulaire">
        <div class="row">
            ...
            <form action="{{url('experiences/'.$experience->id)}}" class="form-horizontal" method="post">
            ...
            <!--Begin Title of Formation-->
                <div class="form-group form-group-lg @if($errors->get('titreex')) has-error @endif">
                    ...
                    <div class="col-sm-10 col-md-4">
                        <input type="text" name="titreex" class="form-control" value="{{$experience->titre}}"/>
                ...
                <div class="form-group form-group-lg @if($errors->get('DateDebutex')) has-error @endif">
                    ...
                    <div class="col-sm-10 col-md-4">
                        <input type="date" name="DateDebutex" class="form-control" value="{{$experience->DateDebut}}"/>
                ...
                <div class="form-group form-group-lg @if($errors->get('DateFinex')) has-error @endif">
                    ...
                    <div class="col-sm-10 col-md-4">
                        <input type="date" name="DateFinex" class="form-control" value="{{$experience->DateFin}}"/>
