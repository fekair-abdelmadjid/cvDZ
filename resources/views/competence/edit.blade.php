@extends('layouts.app')
@section('pageTitle', 'Modifier compétence')
...
@section('content')
    ...
    <div class="container formulaire formulaire2">
        <div class="row">
            ...
            <form action="{{url('competences/'.$competence->id)}}" class="form-horizontal" method="post">
            ...
            <!--Begin Domaine of Formation-->
                <div class="form-group form-group-lg @if($errors->get('Domaine')) has-error @endif">
                    ...
                    <div class="col-sm-10 col-md-4">
                        <input type="text" name="Domaine" class="form-control" value="{{$competence->Domaine}}"/>
                ...
                <div class="form-group form-group-lg @if($errors->get('Competence')) has-error @endif">
                    ...
                    <div class="col-sm-10 col-md-4">
                        <input type="text" name="Competence" class="form-control" value="{{$competence->titre}}"/>
